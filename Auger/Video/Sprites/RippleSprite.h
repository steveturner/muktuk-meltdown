...
//  rippleImage = [ RippleSprite ripplespriteWithFile:@"image.png" ];
...
+( RippleSprite* )ripplespriteWithFile:( NSString* )filename;
-( RippleSprite* )initWithFile:( NSString* )filename;
-( void )tesselate;
